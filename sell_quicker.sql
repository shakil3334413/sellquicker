...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 02, 2019 at 01:28 PM
...
(2, 'admin', 'admin@gmail.com', '$2y$10$Se0eJz2ztRic8lLE.8XQj.VYNfJEPqBKqenIDmP6bAbV5z1rkzdyW', NULL, '2019-06-12 05:03:11', NULL),
...
CREATE TABLE `sell_services` (
  ...
  `authenticity` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `sell_services` (`id`, `user_id`, `image`, `condition`, `brand`, `model`, `edition`, `features`, `description`, `authenticity`, `price`, `na`, `phone`, `status`, `created_at`, `updated_at`) VALUES
(1, 3, NULL, 'used', 'MI', 'Samsung', 'sdfsdf', NULL, 'sdfsd sfsdfsdfsdf', 'original', '23', NULL, NULL, 0, '2019-09-02 05:02:20', '2019-09-02 05:02:20'),
(2, 3, NULL, 'new', 'Samsung', 'MI', 'gfdgfgf', NULL, 'sdfsdfsdfsdfs', 'refurbished', '45', NULL, NULL, 0, '2019-09-02 05:27:25', '2019-09-02 05:27:25');
...
(3, 'Iqbal Ahmed Tuhin', NULL, NULL, NULL, 'jniqbal1@gmail.com', NULL, '$2y$10$Z5RNBswv2EO.9ZQ66Uv2ceGPtSvvGeGyHWY96PoxRB3Ak1.4uKnlG', NULL, '2019-09-02 05:00:33', '2019-09-02 05:00:33');
